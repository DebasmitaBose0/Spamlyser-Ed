...
# Default confidence threshold for models without a dedicated prediction method
DEFAULT_PREDICTION_CONFIDENCE: float = float(
    os.getenv("SPAMLYSER_DEFAULT_CONFIDENCE", "0.5")
)
